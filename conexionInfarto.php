...
try{
  $conexion = new PDO('mysql:host=localhost;dbname=u972837353_infarto', 'u972837353_infartohraei', 'InfartoHraei2022.-.');
...
@mysqli_query($conexion2, "SET NAMES 'utf8'");
  $host = 'localhost';
  $basededatos = 'u972837353_infarto';
  $usuario = 'u972837353_infartohraei';
  $contraseña = 'InfartoHraei2022.-.';
